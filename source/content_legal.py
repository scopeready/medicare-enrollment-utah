"""Utah FAQ page, About, Privacy, Terms."""
FAQ_PAGE = [
    ...
    ("Do I have to choose between Intermountain and the University of Utah?", "Not with Original Medicare and a Medigap policy &mdash; both accept Medicare and both are covered with no network. With Medicare Advantage, often yes: Select Health plans are built on Intermountain, and other carriers contract with each system differently. We confirm your doctors before you enroll."),
    ("Does Utah have a Medigap birthday rule or annual switching window?", "No. Your six-month Medigap open enrollment at 65 is the guaranteed window, plus guaranteed-issue events such as an Advantage plan leaving your county. Outside those, Utah insurers can use medical underwriting."),
    ("I am under 65 on Medicare because of a disability. Can I buy Medigap in Utah?", "Utah does not require insurers to sell Medigap before 65, so most do not, and the few that do often charge more. The Utah Insurance Department&rsquo;s comparison tool lists them. You get a fresh open enrollment for every plan at 65."),
    ("Does my Salt Lake Advantage plan work in St. George?", "Only as the plan&rsquo;s rules allow. Plans are sold by county; an HMO from Salt Lake County usually covers emergencies only in Washington County unless its service area includes it, and some Utah plans do cover both ends of I-15. We check before you enroll."),
    ("I winter in Mesquite or Arizona. Which plan works?", "A Medigap policy with Original Medicare works anywhere in the U.S. Most Medicare Advantage HMOs cover only emergencies out of state; some PPOs and travel benefits go further. See our snowbird guide, and our Nevada and Arizona sister sites."),
    ("I retired from Hill AFB with TRICARE For Life. Do I need a Medigap policy or Part D?", "Usually neither. TFL pays secondary to Medicare and its pharmacy is creditable drug coverage. An MA-only Advantage plan can add dental or vision without duplicating the drug benefit. Our Hill AFB page walks through it."),
...
<li>Sister sites: <a href="https://www.medicareenrollmentarizona.com" rel="noopener">Medicare Enrollment Arizona</a>, <a href="https://georgiamedicareenrollment.com" rel="noopener">Georgia Medicare Enrollment</a>, <a href="https://minnesotamedicareenrollment.com" rel="noopener">Minnesota Medicare Enrollment</a>, <a href="https://medicareenrollmentnevada.com" rel="noopener">Medicare Enrollment Nevada</a>, <a href="https://texasmedicareenrollment.com" rel="noopener">Texas Medicare Enrollment</a>, and <a href="https://www.mymedigaprate.com" rel="noopener">MyMedigapRate</a>, where Medigap rate filings &mdash; Utah&rsquo;s included &mdash; are published filing by filing.</li>
</ul>
<h2>How to reach him</h2>
<p>Call <a href="tel:[[TEL]]"><strong>[[PHONE]]</strong></a>, email <a href="mailto:[[EMAIL]]">[[EMAIL]]</a>, or use the form at the top of this page. We work with Utahns statewide by phone and video.</p>
"""
...
<p>This Privacy Policy explains how ECOS Medicare Solutions ("we," "us") handles information collected through Medicareenrollmentutah.com (the "Site").</p>
...
<h2>Your choices</h2>
<p>You can opt out of further contact at any time by telling us, replying STOP to texts, or unsubscribing from emails. To request that we delete your information, contact us using the details below. Utah residents may also have rights under the Utah Consumer Privacy Act; contact us to exercise them.</p>
<h2>Data security</h2>
...
<p>By using Medicareenrollmentutah.com (the "Site"), operated by ECOS Medicare Solutions, you agree to these Terms of Use.</p>
...
<p>The Site links to third-party websites (such as Medicare.gov and daas.utah.gov) and to other sites operated by ECOS Medicare Solutions. We are not responsible for the content or practices of third-party sites.</p>
